...
- **[implement](skills/engineering/implement/SKILL.md)** — Build the work a spec or ticket describes, driving `/tdd` internally, then committing, running `/code-review` against that commit, and opening a draft PR.
